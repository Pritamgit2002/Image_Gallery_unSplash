...
const UnsplashImages: React.FC = () => {
  const accessKey = "6ZmYBdxYEioyazp6jxRqbkyOR7R-nCYaetws97CUxTo";
  ...
  return (
    <div>
      <div className="image-container grid grid-cols-2 gap-2 lg:gap-0 md:grid-cols-3 mx-auto w-11/12 justify-around items-center py-3">
              ...
              <Dialog>
                ...
                <DialogContent className="p-2 border-2 border-red-500 overflow-auto">
                  <div className="flex flex-col pt-8 p-2 items-center justify-center overflow-auto">
                    ...
                    <span>likes:{image.social.total_likes}</span>
                  </div>
                </DialogContent>
              </Dialog>
